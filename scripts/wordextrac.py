...
#output the permission dict appName -> ListofKeypermissions			
  def getkeyperm(self, permdict):
	permlist=['android.permission.ACCESS_FINE_LOCATION',
		...
		'android.permission.WRITE_SOCIAL_STREAM','android.permission.GET_ACCOUNTS','android.permission.MANAGE_ACCOUNTS']
...
def Batchparse_xml(xmlrootpath):
	...
	for d in dirs:       
		...
		#print keywordlist
    file_op1=open(proj_path+'/data/49183FullTypePatterns.txt','w')
    try:
...
def highlowfrq(freqdict,threshold):
	...
	print maxfreq
        ...
        file_op1=open(proj_path+'/grouping/dbscan/49183_wordsmore%s'%threshold+'.txt','w')
        try:
        ...
        file_op1=open(proj_path+'/grouping/dbscan/49183_wordsless%s'%threshold+'.txt','w')
        try:
...
def getwordfreq(keyworddict):
	...
	file_op1=open(proj_path+'/grouping/dbscan/49183_wordfreq.json','w')
	try:
...
if __name__=="__main__":
  ...
  #result=Map()
  #BatchpreprocessxmlT(proj_path+'/androidDS/allstdxml/')
  #phrasedict=Batchparse_xml(proj_path+'/androidDS/allstdxml/')

  #AllN=onlysinglenoun(phrasedict)
  #fileout=open(proj_path+'/data/49183FullN.json','w')
  #fileout.write(json.dumps(AllN))
  #fileout.close()


  #AllNN=twonouns(phrasedict)
  #fileout=open(proj_path+'/data/49183FullN+N.json','w')
  #fileout.write(json.dumps(AllNN))
  #fileout.close()

  #AllJN=adjnoun(phrasedict)
  #fileout=open(proj_path+'/data/49183FullJN.json','w')
  #fileout.write(json.dumps(AllJN))
  #fileout.close()


  #filein=open(proj_path+'/data/49183FullN.json','r')
  #keyworddict21=json.load(filein)
  #filein.close()

  #filein=open(proj_path+'/data/49183FullN+N.json','r')
  #keyworddict22=json.load(filein)
  #filein.close()

  #filein=open(proj_path+'/data/49183FullJN.json','r')
  ...
  #fileo=open(proj_path+'/data/49183_apps_descdict.json','w')
  #fileo.write(json.dumps(keyworddict2))
  #fileo.close()
  #print len(keyworddict2)
  #f=open(proj_path+'/data/49183_apps_descdict.json','r')
  #keyworddict2=json.load(f)
  #print len(keyworddict2)
  #getwordfreq(keyworddict2)
		
  filein=open(proj_path+'/grouping/dbscan/49183_wordfreq.json','r')
